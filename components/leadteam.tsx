...
import { Feedbacks } from '@/constantsteam';
                    ...
                    >
                        {Feedbacks.map((feedback) => (
                           ...
                           <div key={feedback.name} className='text-center text-white sm:text-xl select-none px-10 flex flex-col items-center justify-center gap-6 mb-8 sm:mb-14'>
                               ...
                               <p className='max-sm:text-justify max-sm:hyphens-auto max-sm:whitespace-normal leading-8 sm:leading-10' style={{ fontSize: '25px', fontWeight: 'bold', textDecoration: 'underline' }}>
                                   {feedback.comment}
                               </p>
                               <p style={{ fontSize: '20px', textDecoration: 'underline' }}>{feedback.name}</p>
                               <p style={{ fontSize: '15px', textDecoration: 'underline' }} className='text-sm -mt-4'>{feedback.bankName}</p>
                           </div>
                       </SwiperSlide>
